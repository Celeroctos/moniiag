    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Добавить кабинет</h4>
            </div>
            <?php
            ...
            <div class="modal-footer">
                ...
                <?php echo CHtml::ajaxSubmitButton(
                    'Добавить',
                    CHtml::normalizeUrl(Yii::app()->request->baseUrl.'/guides/cabinets/add'),
                    array(
...
<div class="modal fade" id="editCabinetPopup">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Редактировать кабинет</h4>
            </div>
            <?php
            $form = $this->beginWidget('CActiveForm', array(
            ...
            <div class="modal-footer">
                ...
                <?php echo CHtml::ajaxSubmitButton(
                    'Сохранить',
                    CHtml::normalizeUrl(Yii::app()->request->baseUrl.'/guides/cabinets/edit'),
                    array(
                        'success' => 'function(data, textStatus, jqXHR) {
