...
43	Курение	dropdown	46	-1	1	-1	
44	Беременность	dropdown	46	-1	2	-1	
45	Срок беременности	dropdown	46	-1	3	-1	
46	Менструальный цикл	dropdown	46	-1	4	-1	
47	Расовая принадлежность	dropdown	46	-1	5	-1	
161	Тип образца	text	47	-1	1	-1	
162	Подтип образца	text	47	-1	2	-1	
50	Наименование МУ	text	48	-1	1	-1	
51	Notum	yesno	48	-1	2	-1	
...
171	Автоматическая методика	yesno	44	-1	3	-1	
170	Ручная методика	yesno	44	-1	4	-1	
163	Краткое наименование анализа	text	45	-1	1	-1	
164	Наименование параметра	text	45	-1	2	-1	
165	По умолчанию	yesno	45	-1	3	-1	
\.
...
SELECT pg_catalog.setval('guide_column_id_seq', 207, true);
...
SELECT pg_catalog.setval('guide_id_seq', 62, true);
...
SELECT pg_catalog.setval('guide_row_id_seq', 32, true);
...
SELECT pg_catalog.setval('guide_value_id_seq', 112, true);
