$(document).ready(function(e) {
    var ConfigurationInited=false; // Флаг показывающий, работает ли на данной странице
    ...
    for (i=0;i<keyboard_cnf.page_configs.length;i++) {
        ...
        if (pageAddr.match(keyboard_cnf.page_configs[i].page_key)!=null) {
               ...
               // Ставим флаг, что конфигурация найдена для странице
    ...
    {
        // Если когнфигурация не инициализирована - не обрабатываем нажатие на tab
        ...
        //   АААААА, не убивай меня, я хочу жить!!!! :)
